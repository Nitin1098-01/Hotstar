...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference('Favourite.count') do
      post favourites_url, params: { favourite: { channel_id: @favourite.channel_id, show_id: @favourite.show_id } }
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { channel_id: @favourite.channel_id, show_id: @favourite.show_id } }
